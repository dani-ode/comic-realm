...
<template>
    <div class="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
        <!-- Global Toast Notifications & Global Loaders -->
        <ToastContainer />
        <TopProgressBar />
        <FullpageLoader />
        ...
        <header
            v-else
            class="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800/80"
        >
            <div class="px-4 lg:px-8 py-3.5 flex items-center justify-between gap-4">
                <!-- Logo -->
            ...
            <nav v-if="!minimal" class="md:hidden border-t border-slate-800/50 px-3 py-2 flex items-center gap-2 text-xs font-medium overflow-x-auto shrink-0 scrollbar-none">
                <Link
                    href="/studios"
